...
*/
  ...
  return (
    <div id="flex">
      ...
      ? <Redirect to='/administration/menu'/>
      : <Link to={{pathname:'/administration/class',state: {id: {selectedID}, name: props.location.state.value.name, class: {selectedName}}}}><button id="valider">Valider</button></Link>
      }
    </div>
  );
};
