...
*/
  ...
  return (
    <div id="flex">
      ...
      {redirectAdd && <Redirect to={{pathname:'/administration/editMolecule', state:{molecule:{newMoleculeName}}}}/>}
      {redirectEdit && <Redirect to={{pathname:'/administration/editMolecule', state:{molecule:{selectedData}}}}/>}
    </div>
  );
};
